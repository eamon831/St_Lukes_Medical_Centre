...
public class kopal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kopal);
    ...
    private void prepareRecyclerView() {
        ...
        imageRVAdapter = new RecyclerViewAdapter(kopal.this, imagePaths);

        // on below line we are creating a new grid layout manager.
        GridLayoutManager manager = new GridLayoutManager(kopal.this, 4);
